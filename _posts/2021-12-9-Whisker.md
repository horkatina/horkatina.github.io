...
- The neural network model of 4 whiskers was able to classify concave and convex shapes with __peak moment_ with 0.92 accuracy.
- Inaccessibility to modify whisking amplitude in WHISKiT Physics simulator limited replicating Chris Rodger’s experiments.
- The neural network model of 54 whiskers was able to classify concave and convex shapes with __contact duration_ with 0.92 accuracy while the rat was actively rotating its yaw.
...
[![IMAGE_ALT](https://www.youtube.com/watch?v=_m3zXwX3_xM&list=PLkjNjWTz5JlvFrvjH6XcShzkwcHC1xHif&index=11&ab_channel=DonghoKang/0.jpg)](https://www.youtube.com/watch?v=_m3zXwX3_xM&list=PLkjNjWTz5JlvFrvjH6XcShzkwcHC1xHif&index=11&ab_channel=DonghoKang)
...
The inner radius of both concave and convex objects varied 20 mm to 40 mm by 2 mm increment.  The orientation of the rat head was varied by randomly adjusting the yaw of the rat head by +-90 degrees. Five cycles of whisking over each object were simulated 1,200 times, outputting 132,000 samples. Each sample contained data of force, moment, and contact of 54 whiskers during one cycle of whisking (125 ms in simulation time). 
...
[![IMAGE_ALT](https://www.youtube.com/watch?v=QAoV4th5TsM&list=PLkjNjWTz5JlvFrvjH6XcShzkwcHC1xHif&index=6/0.jpg)](https://www.youtube.com/watch?v=QAoV4th5TsM&list=PLkjNjWTz5JlvFrvjH6XcShzkwcHC1xHif&index=6)
...
[![IMAGE_ALT](https://www.youtube.com/watch?v=5qes33DmmsY&ab_channel=DonghoKang/0.jpg)](https://www.youtube.com/watch?v=5qes33DmmsY&ab_channel=DonghoKang)
...
## Replication of Rodger’s Experiment
### __Whisking Amplitude Adjustment is Necessary To Replicate a Real Rat__
...
### __Temporal dependent Input Data Allows Successful Classification__
...
## Data Conversion and Image Classification
### __Contact Data Conversion to Gray Image __ ##
...
### __Moment Data Conversion to RGB Image __ ##
